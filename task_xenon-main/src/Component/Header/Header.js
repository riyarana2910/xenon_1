...
const Header = () => {
    ...
    <div>
        <header className='header'>
            ...
            <NavLink to="/home" className='logo ItemLink'><span>Rent</span>Car</NavLink>
...
<li>  <NavLink   to="/allCars" className='ItemLink'>Vehicles</NavLink></li>
...
''
                    ...
                    <nav className='navbar'>
                        ...
                        <NavLink to="/allCars" className='ItemLink'>Vehicles</NavLink>
